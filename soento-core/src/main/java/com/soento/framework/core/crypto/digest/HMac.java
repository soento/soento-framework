...
public class HMac {
    ...
    public HMac init(String algorithm, SecretKey key) {
        try {
            ...
            if (null != key) {
                ...
                this.secretKey = CryptoUtil.generateKey(algorithm);
            }
    ...
    public String digestHex(String data, String charset) {
        return HexUtil.encode(digest(data, charset));
    }
    ...
    public String digestHex(String data) {
        return digestHex(data, Charset.UTF8.value());
    }
    ...
    public String digestHex(File file) {
        return HexUtil.encode(digest(file));
    }
    ...
    public String digestHex(byte[] data) {
        return HexUtil.encode(digest(data));
    }
    ...
    public String digestHex(InputStream data, int bufferLength) {
        return HexUtil.encode(digest(data, bufferLength));
    }
