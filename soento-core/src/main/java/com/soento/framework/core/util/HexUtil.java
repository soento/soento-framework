...
public final class HexUtil {
    ...
    public static String encode(String data, Charset charset) {
        return encode(StringUtil.bytes(data, charset), true);
    }
    ...
    public static String encode(String data) {
        return encode(data, Charset.UTF8);
    }
    ...
    public static String decode(String hexStr) {
        return decode(hexStr, Charset.UTF8);
    }
    ...
    public static String decode(String hexStr, Charset charset) {
        ...
        return decode(hexStr.toCharArray(), charset);
    }
    ...
    public static String decode(char[] hexData, Charset charset) {
        return StringUtil.toEncodedString(decodeHex(hexData), charset.instance());
    }
