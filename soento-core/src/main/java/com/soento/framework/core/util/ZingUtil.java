...
import com.soento.framework.core.zxing.BufferedImageLuminanceSource;
import com.soento.framework.core.zxing.MatrixToImageWriter;
import com.soento.framework.core.zxing.MatrixToLogoImageConfig;
...
public class ZingUtil {
    ...
    private static Logger logger = LoggerFactory.getLogger(ZingUtil.class);
    ...
    public static byte[] createQrcode(String content, int length, File logoFile) {
        ...
        try {
            File file = File.createTempFile("qrcode_", "." + FORMAT);
